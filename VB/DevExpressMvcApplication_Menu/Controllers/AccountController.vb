...
Imports DevExpressMvcApplication_Menu.Models
...
Namespace DevExpressMvcApplication_Menu.Controllers
	...
	Public Class AccountController
		...
		Private privateFormsService As IFormsAuthenticationService
		Public Property FormsService() As IFormsAuthenticationService
			Get
				Return privateFormsService
			End Get
			Set(ByVal value As IFormsAuthenticationService)
				privateFormsService = value
			End Set
		End Property
...
'ORIGINAL LINE: FormsService.SignIn(model.UserName, false /* createPersistentCookie */);
